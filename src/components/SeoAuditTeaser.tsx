...
export default function SeoAuditTeaser() {
  ...
  const inputClass =
    "w-full rounded-xl border border-border bg-background px-5 py-4 text-sm text-foreground placeholder-muted outline-none transition-all focus:border-gold focus:ring-1 focus:ring-gold/30";
